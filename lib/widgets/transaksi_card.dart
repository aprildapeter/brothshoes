...
class TansaksiCard extends StatefulWidget {
  const TansaksiCard({Key key}) : super(key: key);

  @override
  State<TansaksiCard> createState() => _TansaksiCardState();
}

DateTime selectDate = DateTime.now();

class _TansaksiCardState extends State<TansaksiCard> {
  @override
